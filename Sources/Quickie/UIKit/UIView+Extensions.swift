...
public extension UIView {
    ...
    /// parent respecting the given margin and layout-constraint priority.
    /// - parameter parent: The parent to add the view to.
    /// - parameter insets: The top, leading, bottom and trailing insets of the sub its parent view.
    /// - parameter priority: The priority all constraints should be given to avoid constraint warnings
    ///                       in the console when e.g. the view is inside a stack view and is hidden
    ///                       during the app lifecycle.
    func addMaximizedTo(_ parent: UIView, insets: NSDirectionalEdgeInsets = .zero, priority: UILayoutPriority? = nil) {
    ...
    func setWidth(_ value: CGFloat, prio: UILayoutPriority? = nil) -> NSLayoutConstraint {
    ...
    func setHeight(_ value: CGFloat, prio: UILayoutPriority? = nil) -> NSLayoutConstraint {
