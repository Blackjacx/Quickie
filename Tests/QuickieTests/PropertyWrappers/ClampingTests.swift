...
//  QuickieTests
//
//  Created by Stefan Herold on 26.02.20.
//
...
final class ClampingTests: XCTestCase {
    ...
    static var allTests = [
        ("testClampingOnWrappedValueInit", testClampingOnWrappedValueInit),
        ("testClampingOnSeparateParamInit", testClampingOnAlternativeInit)
    ]
}
